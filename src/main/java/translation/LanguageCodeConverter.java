    ...
    public LanguageCodeConverter(String filename) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                String regex = "\t";
                String[] languageAndCode = line.split(regex);
                languageCodeToLanguage.put(languageAndCode[1], languageAndCode[0]);
                languageToLanguageCode.put(languageAndCode[0], languageAndCode[1]);
            }
